...
Hai hàm trên có công dụng ngăn R xuất ra output vậy nên nếu bạn muốn R trở lại bình thường thì chỉ cần chạy thêm hàm `sink()` là xong.
...
#| warning: false
#| message: false
#| column: column-screen-inset-left
predict<-k %>% 
